...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "ptg4a18xx3ek6k2fckrz96n7zxpugsm8p2p3qp7kcy7q0sgjetth",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "WebDAV Server"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New WebDAV Server"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://github.com/mnutt/dav-test-server",
      # This should be the app's main website url.

      codeUrl = "https://github.com/mnutt/dav-test-server",
      ...
      shortDescription = (defaultText = "WebDAV Server"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  environ = [
    ...
    (key = "PORT", value = "8000"),
    (key = "STORAGE_PATH", value = "/var/dav/data"),
    (key = "TEMP_STORAGE_PATH", value = "/var/dav/tmp"),
    (key = "TMPDIR", value = "/var/dav/tmp"),
  ]
);
